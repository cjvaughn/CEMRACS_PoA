...
\begin{proof}
	...
	\end{equation*}
	$$
	1=\frac{ \frac{C^\eta}{b_2}+D^\eta\frac{\delta^{+,b_2}_\eta}{b_2}-c_\eta \left(\frac{D^\eta}{r+\bar{r}} -\frac{\delta^{-,b_2}_\eta}{b_2^2}\right)+\left(-\frac{C^\eta}{b_2}-D^\eta\frac{\delta^{-,b_2}_\eta}{b_2} -c_\eta \left(\frac{\delta^{+,b_2}_\eta}{b_2^2} -\frac{D^\eta}{r+\bar{r}}\right)\right)e^{-(\delta^{+,b_2}_\eta-\delta^{-,b_2}_\eta)(T-t^*_{b_2})} }{ \frac{D^\eta}{r+\bar{r}} -\frac{\delta^{-,b_2}_\eta}{b_2^2} +\left(\frac{\delta^{+,b_2}_\eta}{b_2^2} -\frac{D^\eta}{r+\bar{r}}\right) e^{-(\delta^{+,b_2}_\eta-\delta^{-,b_2}_\eta)(T-t^*_{b_2})}}.
	$$
	...
	&= \left[-\frac{\delta^{-,b_2}_\eta D^\eta}{b_2}+\frac{D^\eta}{r+\bar{r}}(1+c_\eta)+ToDo \right] e^{-\left(\delta^{+,b_2}_\eta -\delta^{-,b_2}_\eta\right)(T-t^*_{b_2})} \\
	&\leq  \left[-\frac{\delta^{-,b_2}_\eta D^\eta}{b_2}+\frac{D^\eta}{r+\bar{r}}(1+c_\eta) \right] e^{-\left(\delta^{+,b_2}_\eta -\delta^{-,b_2}_\eta\right)(T-t^*_{b_2})}.
	\end{split}
	\label{eq:lemma_1}
	\end{equation}
