...
\begin{proof}
	...
	Now we are ready to show that $\lim_{b_2 \to \infty} \frac{\Delta SC}{SC^{MKV}} = 0$. Our approach is to split the interval $[0,T]$ into two parts: $[0,\frac{T}{2}]$ and $[\frac{T}{2},T]$.	
	...
	\begin{IEEEeqnarray}{rCl}
		...
		&=& 2\zeta_2^2 \cdot \frac{e^{2T(b_1 + \bar{b}_1)}}{\frac{c}{2}} \left( 1 - e^{ - \frac{2(b_2 + \bar{b}_2) \frac{c}{2}}{r + \bar{r}(1-\bar{s})^2}  \frac{T}{2} } \right) \\
	...
	and 
	\begin{equation*}
		\int_0^{t_1^{b_2}} h_u(b_2,s) ds \geq \int_0^{\frac{T}{2}} h_u(b_2,s) ds \geq \frac{T}{2} m_u.
	\end{equation*}
	Combining this with (\ref{eq:I2_b2_infity_Mean_Value}) gives:
	\begin{equation*}
		I_2^{b_2} \leq  \frac{4 T M^2 e^{2(b_1 + \bar{b}_1) T} }{r + \bar{r}(1-\bar{s})^2} (b_2 + \bar{b}_2)^3 e^{- \frac{2 \frac{T}{2}  m_u}{r + \bar{r}(1-\bar{s})^2} (b_2 + \bar{b}_2) } = \kappa_3 (b_2 + \bar{b}_2)^3 e^{- \kappa_4 (b_2 + \bar{b}_2)} \xrightarrow[b_2 \to \infty]{} 0,
	\end{equation*}
	where $\kappa_3 = \frac{4 TM^2 e^{2(b_1 + \bar{b}_1) T} }{r + \bar{r}(1-\bar{s})^2} >0$ and $\kappa_4 :=  \frac{2 \frac{T}{2}  m_u}{r + \bar{r}(1-\bar{s})^2}>0$ are constants independent of $b_2$. 	
