...
\begin{proof}
	...
	(b_2 + \bar{b}_2) e^{- \kappa (b_2 + \bar{b}_2)^{1/2} h(\bar{b}_2) }  & 	\displaystyle  = e^{- \kappa (b_2 + \bar{b}_2)^{1/2} (h(\bar{b}_2) - c_3 + 2\epsilon_1 )}\cdot e^{- \kappa  (c_3 - 2 \epsilon_1) (b_2 + \bar{b}_2)^{1/2} +  \ln (b_2 + \bar{b}_2) } \\
		&	\displaystyle  \leq  e^{- \kappa (b_2+\bar{b}_2^{*,1})^{1/2} \epsilon_1 } \cdot e^{- \kappa (c_3 - 2 \epsilon_1 ) (b_2 + \bar{b}_2)^{\frac{1}{2}} + \ln (b_2 + \bar{b}_2)} \\
		& 	\displaystyle  = c_5 e^{- \kappa (c_3 - 2 \epsilon_1) (b_2 + \bar{b}_2)^{1/2} + \ln (b_2 + \bar{b}_2)} \\
		& \xrightarrow[\bar{b}_2 \to \infty]{}0.
	\end{array}
	\end{equation*}
	Namely, for any $\epsilon>0$, there exists a $\bar{b}_2^{*,2} \geq \bar{b}_2^{*,1}$, such that for all $\bar{b}_2>\bar{b}_2^{*,2}$ we have:
	\begin{equation}
	...
	\end{split}
	\end{equation*}
	where we have used the fact that $\lim_{\bar{b}_2 \to \infty}\frac{\delta^{\pm,\bar{b}_2}_w}{b_2 + \bar{b}_2}=\sqrt{\frac{C^w}{r+\bar{r}(1-\bar{s})^2}}$. Thus, $\left\vert w_{t_1}^{\bar{b}_2} \right\vert $ can also be bounded by $c_4 + \epsilon$ for large enough $\bar{b}_2$.
