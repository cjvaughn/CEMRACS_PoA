...
\end{comment}
	...
	(ToDo: Show $(\bar{b}_1-B u_0^{\bar{b}_1}) \to 0$.)
	
	Let $\zeta_2>0$. Since $\lim_{\bar{b}_1 \to \infty}(\bar{b}_1-B u_0^{\bar{b}_1}) = 0$, there exists $\bar{b}_1^{*} \geq \max \{\bar{b}_1^{*,u,w},\bar{b}_1^{*,dec} \}$, such that for $\bar{b}_1 \geq \bar{b}_1^{*}$,
	\begin{equation*}
