...
\end{comment}
	...
	Todo: case $b_1 \to \infty$ and $\bar{b}_1 \to \infty$.
	
	Now, consider $\bar{b}_1 \to \infty$.
	Since $\lim_{\bar{b}_1 \to \infty} |A^{u,\bar{b}_1}|=\infty$, we have:
	\begin{equation*}
	\begin{split}
	\delta^{+,\bar{b}_1}_u-\delta^{-,\bar{b}_1}_u&=2 \sqrt{(A^{u,\bar{b}_1})^2+BC^u} \\
	&\xrightarrow[\bar{b}_1 \to \infty]{}\infty,
	\end{split}
	\end{equation*}
	and
	\begin{equation*}
	\begin{split}
	-\delta^{-,\bar{b}_1}_u&=A^{u,\bar{b}_1}+\sqrt{(A^{u,\bar{b}_1})^2+BC^u} \\
	&\xrightarrow[\bar{b}_1 \to \infty]{}0.
	\end{split}
	\end{equation*}
	Therefore, it can be shown that for $t \in [0,T)$:
	\begin{equation*}
	...
	Thus,
	\begin{equation*}
	\lim_{\bar{b}_1 \to \infty} \left(\frac{u^{\bar{b}_1}_t}{\bar{b}_1}-\frac{w^{\bar{b}_1}_t}{\bar{b}_1}\right)^2=\frac{1}{B^2}.
	\end{equation*}
	...
	Since $\lim_{\bar{b}_1 \to \infty}B (D^{u})^2 + 2 A^{u,\bar{b}_1} D^{u} - C^{u}=-\infty$, from equation (\ref{eq:riccati_ut_sol_deriv}) there exists a $\bar{b}_1^{*,dec}$ such that for $\bar{b}_1 \geq \bar{b}_1^{*,dec}$, $t \mapsto u_t^{\bar{b}_1}$ is decreasing, and thus, $(\bar{b}_1-B u_t^{\bar{b}_1})\geq (\bar{b}_1-B u_{0}^{\bar{b}_1})$.
	
	(ToDo: Show $\lim_{\bar{b}_1 \to \infty}(\bar{b}_1-B u_0^{\bar{b}_1}) \geq 0$.)
	
	Next, we show $\lim_{\bar{b}_1 \to \infty}(\bar{b}_1-B u_0^{\bar{b}_1}) \geq 0$. We have: (ToDo don't use $\xi$, add superscripts)
	\begin{equation*} 
	\bar{b}_1-Bu^{\bar{b}_1}_0=\frac{BD(\bar{b}_1-\delta^+_u)-\delta^-_u\bar{b}_1-BC+(BC+BD\delta^-_u+\delta^+_u\bar{b}_1-BD\bar{b}_1)e^{-(\delta^+_u-\delta^-_u)T}}{-\delta^-_u+BD+(\delta^+_u-BD) e^{-(\delta^+_u-\delta^-_u)T}}
	\end{equation*}
	
	Let $\zeta_2>0$. Since $\lim_{\bar{b}_1 \to \infty}(\bar{b}_1-B u_0^{\bar{b}_1}) \geq 0$, there exists $\bar{b}_1^{*} \geq \max \{\bar{b}_1^{*,u,w},\bar{b}_1^{*,dec} \}$, such that for $\bar{b}_1 \geq \bar{b}_1^{*}$,
	\begin{equation*}
	\frac{1}{\bar{b}_1^2}\Delta SC^{\bar{b}_1}\geq \frac{1}{4B}(\mathbb{E}(\xi))^2 \int_0^{\frac{T}{2}}e^{2tb_1}e^{-2t\zeta_2}dt=:c_{\Delta SC}>0,
	\end{equation*}
	and therefore:
	\begin{equation*}
