...
\begin{proposition}
	Assuming assumption \ref{assumption}, and if
	\begin{equation*}
...
\begin{remark}
	...
	From equation (\ref{eq:riccati_limiting_u}) and an analogous Riccati equation for $w_t^{\bar{b}_2 \to 0}$, the above equality implies $ D^{u,\bar{b}_2 \to \infty} =  u_T^{\bar{b}_2 \to 0} = w_T^{\bar{b}_2 \to 0} = D^w$ and:
