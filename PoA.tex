...
\begin{proof}
	...
	\begin{IEEEeqnarray*}{rCl}
		(b_2 + \bar{b}_2) u_t &=& \frac{ \displaystyle - \left(\frac{C^u}{b_2 + \bar{b}_2} + D^u \cdot \frac{\delta^+_u}{b_2 + \bar{b}_2}\right) + \left(\frac{C^u}{b_2 + \bar{b}_2} + D^u \cdot \frac{\delta^-_u}{b_2 + \bar{b}_2}\right)e^{- (\delta^+_u - \delta^-_u)(T-t)} }
	...
	\begin{IEEEeqnarray*}{rCl}
		...
		&=& \frac{\mathbb{E}(\xi)^2}{2} \int_0^T \left[ (\sqrt{\zeta_1 \kappa_u^2} - \sqrt{q+\bar{q}(1-s)^2}) + \mathcal{O}(b_2^{-1})\right]^2 \cdot e^{2 (b_1+\bar{b}_1 - \kappa_u (b_2 + \bar{b}_2) - (A^u - \bar{b}_2 \kappa_u / 2) ) t} e^{-2 \int_0^t h_s(b_2) ds} dt\\
		...
		&& + \frac{\mathbb{E}(\xi)^2  (\sqrt{\zeta_1 \kappa_u^2} - \sqrt{q+\bar{q}(1-s)^2}) ^2}{2} \int_0^T \left[ (1 + \mathcal{O}(b_2^{-1}) ) e^{-2 \int_0^t h_s(b_2)} -1\right]\cdot e^{2 (b_1+\bar{b}_1 - \kappa_u (b_2 + \bar{b}_2) - (A^u - \bar{b}_2 \kappa_u / 2) ) t}  dt
	\end{IEEEeqnarray*}
	...
	$$ \left\vert e^{-2\int_0^t h_s(b_2) ds} - 1 \right\vert \leq \left\vert e^{ \mathcal{O}(b_2^{-1}) } -1 \right\vert = \mathcal{O}(b_2^{-1}).$$
	Together with the estimation of the first term above, we have 
	$$ \int_0^T \left[ (1 + \mathcal{O}(b_2^{-1}) ) e^{-2 \int_0^t h_s(b_2)} -1\right]\cdot e^{2 (b_1+\bar{b}_1 - \kappa_u (b_2 + \bar{b}_2) - (A^u - \bar{b}_2 \kappa_u / 2) ) t}  dt = \mathcal{O}(b_2^{-2}).$$
...
\begin{proof}
	...
	Our next step is to show that $(b_2 + \bar{b}_2) e^{- \kappa (b_2 + \bar{b}_2)^{\frac{1}{2}} h(\bar{b}_2) } $ tends towards $0$ when $\bar{b}_2 \to \infty$. We previously showed that $\lim_{\bar{b}_2 \to \infty}h(\bar{b}_2)= c_3 >0$. Let $c_{b_2}$ such that $0<c_{b_2} <\frac{c_3}{2} $. Then there exists $\bar{b}_2^{*,1}>0$ so that for all $\bar{b}_2 > \bar{b}_2^{*,1}$ we have $\left\vert h(\bar{b}_2) - c_3 \right\vert < c_{b_2}$. Then $h(\bar{b}_2) - c_3 + 2c_{b_2} > c_{b_2}$ and 
	\begin{equation*}
	\begin{array}{rl}
		(b_2 + \bar{b}_2) e^{- \kappa (b_2 + \bar{b}_2)^{\frac{1}{2}} h(\bar{b}_2) }  &= e^{- \kappa (b_2 + \bar{b}_2)^{\frac{1}{2}} (h(\bar{b}_2) - c_3 + 2c_{b_2}) }\cdot e^{- \kappa  (c_3 - 2 c_{b_2}) (b_2 + \bar{b}_2)^{\frac{1}{2}} +  \ln (b_2 + \bar{b}_2) } \\
		& \leq  e^{- \kappa (b_2+\bar{b}_2^{*,1})^{\frac{1}{2}} \cdot c_{b_2}} \cdot e^{- \kappa (c_3 - 2 c_{b_2}) (b_2 + \bar{b}_2)^{\frac{1}{2}} + \ln (b_2 + \bar{b}_2)} \\
		&=:c_5 e^{- \kappa (c_3 - 2 c_{b_2}) (b_2 + \bar{b}_2)^{\frac{1}{2}} + \ln (b_2 + \bar{b}_2)} \\
		& \xrightarrow[\bar{b}_2 \to \infty]{}0.
	\end{array}
	\end{equation*}
	Let $\epsilon>0$. Then there exists a $\bar{b}_2^{*,2}>\bar{b}_2^{*,1}$, such that for all $\bar{b}_2>\bar{b}_2^{*,2}$, we have:
	\begin{equation}
	...
	\end{equation}
 	...
 	Now, in order to show that $\Delta SC$ tends to $0$, we need to bound the terms $u_{t_1}^{\bar{b}_2}$ and $w_{t_1}^{\bar{b}_2}$ for large enough $\bar{b}_2$. Given $\epsilon>0$, there exists a $\bar{b}_2^{*,3} > 1$ such that for any $\bar{b}_2 > \bar{b}_2^{*,3}$ we have $ (b_2 + \bar{b}_2)^{\frac{3}{2}} \left\vert u_{t_1}^{\bar{b}_2} \right\vert \leq c_3 + \epsilon$. Thus, for any $\bar{b}_2 > \bar{b}_2^{*,3}$ we deduce:
 	$$ \left\vert u_{t_1}^{\bar{b}_2} \right\vert \leq \frac{c_3 + \epsilon}{(b_2 + \bar{b}_2)^{\frac{3}{2}} } \leq c_3 + \epsilon.
 	$$
	...
	\end{split}
	\end{equation*}
	where we have used the fact that $\lim_{\bar{b}_2 \to \infty}\frac{\delta^{\pm,\bar{b}_2}_w}{b_2 + \bar{b}_2}=\sqrt{\frac{C^w}{r+\bar{r}(1-\bar{s})^2}}$. Thus, $\left\vert w_{t_1}^{\bar{b}_2} \right\vert $ can also be bounded $c_4 + \epsilon$ for large enough $\bar{b}_2$.
