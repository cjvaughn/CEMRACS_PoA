...
% uniform upper bound for u_t and w_t
	...
	\end{equation}
	Furthermore, we can get a uniform lower bound for $(b_2 + \bar{b}_2)^{\frac{3}{2}} u_t^{\bar{b}_2}$. Namely for all $t \in [0,T]$ and $\bar{b}_2 \geq \bar{b}_2^{*,u}$:
	\begin{equation}
	...
	\end{equation}
	where $\zeta = \frac{b_2 (r + \bar{r}(1-\bar{s})^2) (q_T + \bar{q}_T(1-s_T))}{r + \bar{r}(1-s)}$.
