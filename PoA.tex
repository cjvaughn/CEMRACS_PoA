...
\begin{proof}
	...
	\begin{IEEEeqnarray}{rCl}
		\Delta SC &=& \frac{1}{2} B^{\bar{b}_2} \int_0^T (u_t- w_t)^2 (\bar{x}_t^{MFG,\bar{b}_2} )^2 dt  \nonumber \\
	...
	\end{IEEEeqnarray}
	where  $\kappa = \frac{t_1}{r + \bar{r}(1-\bar{s})^2} >0 $ and $\kappa_1 =\frac{T \mathbb{E}[\xi]^2 e^{2 (b_1 + \bar{b}_1) t_1}}{2 (r + \bar{r}(1-\bar{s})^2)} >0$ are two positive constants independent of $\bar{b}_2$, and $h(\bar{b}_2) = (b_2 + \bar{b}_2)^{\frac{3}{2}} u_{t_2}^{\bar{b}_2}$. 
