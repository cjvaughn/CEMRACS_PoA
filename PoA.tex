...
\begin{proof}
	...
	\end{split}
	\end{equation*}
	Similar to the proof of Proposition \ref{prop:r_bar_r}, it can be shown that there exists a $c>0$ and $\bar{b}_2^*$ such that for $\bar{b}_2>\bar{b}^*_2$ and $\forall t \in [0,T]$:
	\begin{equation*}
	\begin{split}
