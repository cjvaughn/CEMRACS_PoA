...
\begin{proposition}
	...
	\begin{equation*}
	\begin{split}
	q_T+\bar{q}_T(1-s_T)&>0 \\
	q_T+\bar{q}_T(1-s_T)^2&>0 \\
	\frac{q+\bar{q}(1-s)}{r+\bar{r}(1-\bar{s})}&=\frac{q+\bar{q}(1-s)^2}{r+\bar{r}(1-\bar{s})^2},
	\end{split}
	\end{equation*}
	and the initial condition $\xi$ satisfies $\mathbb{E}(\xi)\neq 0$, then:
...
\begin{proof}
	...
	Therefore,
	\begin{IEEEeqnarray}{rCl}
		I_1^{b_2} &\leq& 4\zeta_2^2e^{2T(b_1 + \bar{b}_1)} \cdot\frac{(b_2 + \bar{b}_2)}{r+ \bar{r}(1-\bar{s})^2} \int_0^{t^*} \exp \left(  - \frac{2 (b_2 + \bar{b}_2)}{r + \bar{r}(1-\bar{s})^2} \cdot \frac{c}{2}\cdot t \right) dt \nonumber \\
		&=& 2\zeta_2^2 \cdot \frac{e^{2T(b_1 + \bar{b}_1)}}{\frac{c}{2}} \left( 1 - e^{ - \frac{2(b_2 + \bar{b}_2) \frac{c}{2}}{r + \bar{r}(1-\bar{s})^2}  t^* } \right) \\
		&\leq& \frac{4e^{2T(b_1 + \bar{b}_1)}}{c}\cdot \zeta_2^2\\
		&\leq&\epsilon, 
	...
	\begin{equation*}
		\frac{\Delta SC^{b_2}}{SC^{MKV,b_2}} \leq \frac{I_1^{b_2} + I_2^{b_2}}{(b_2 + \bar{b}_2) w_0^{b_2}} \leq \frac{ \epsilon + \epsilon }{h_w(b_2,0)} \leq \frac{2\epsilon}{c_w - \zeta_2}.
	\end{equation*}
