...
\begin{equation*}
    b(t,x,\mu,\alpha,\nu)=\alpha.
\end{equation*}
Suppose the initial condition is $X_0=1$. They choose their control with two goals in mind: to minimize their effort put into their control, and to align their velocity with the average velocity of the group. Thus, they consider the cost functions given by:
\begin{equation*}
\begin{split}
    f(t,x,\mu,\alpha,\nu)&=\frac{1}{2}\left(|x-\bar{\mu}|^2 +\alpha^2 \right), \\
    g(x,\mu)&=0.
\end{split}
\end{equation*}
