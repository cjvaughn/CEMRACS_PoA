...
\begin{proof}
	...
	\end{equation*}
	Moreover, $\bar{x}_t^{r,MFG}$ is uniformly bounded over $r>r^*$ and $t \in [0,T]$. From the nonnegativity of $u_t$, we have:
	$$ \vert \bar{x}^{r,MFG}_t \vert \leq \vert \mathbb{E}(\xi) \vert e^{ (b_1 + \bar{b}_1 ) T }, \quad \forall t \in [0,T],\ r>r^*. $$  
...
\begin{proof}
	...
	Moreover, $\bar{x}^{\bar{b}_2,MFG}$ is uniformly bounded for all $\bar{b}_2<\bar{b}^*_2$ and for all $t \in [0,T]$. From the nonnegativity of $u_t$, we have:
	$$ \vert \bar{x}^{\bar{b}_2,MFG}_t \vert \leq \vert \mathbb{E}(\xi) \vert e^{ (b_1 + \bar{b}_1 ) T }, \quad \forall t \in [0,T], \ \forall \bar{b}_2<\bar{b}^*_2. $$ 
