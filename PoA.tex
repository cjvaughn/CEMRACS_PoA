...
\begin{proposition}
	Assuming (\ref{eq:assumptions}), and the initial condition $\xi$ satisfies $\mathbb{E}(\xi)\neq 0$. Moreover, we assume that $q_T+\bar{q}_T(1-s_T)>0$, $q_T+\bar{q}_T(1-s_T)^2>0$, $q_T + \bar{q}_T > 0$ and 
	\begin{equation*}
