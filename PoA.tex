...
\end{comment}
	...
	%\end{equation*}
	Since $\lim_{\bar{b}_1 \to \infty}B (D^{u})^2 + 2 A^{u,\bar{b}_1} D^{u} - C^{u}=-\infty$, from equation (\ref{eq:riccati_ut_sol_deriv}) there exists a $\bar{b}_1^{*,dec}$ such that for $\bar{b}_1 \geq \bar{b}_1^{*,dec}$, $t \mapsto u_t^{\bar{b}_1}$ is decreasing, and thus, $(\bar{b}_1-B u_t^{\bar{b}_1})\geq (\bar{b}_1-B u_{0}^{\bar{b}_1})$. Next, we will show $\lim_{\bar{b}_1 \to \infty}(\bar{b}_1-B u_0^{\bar{b}_1})=c$. We have the following limits for $t\in[0,T)$:
	\begin{equation*}
	\begin{split}
	...
	Since $\lim_{\bar{b}_1 \to \infty}(\bar{b}_1-B u_0^{\bar{b}_1}) =-2b_1$, there exists $\bar{b}_1^{*}\geq\bar{b}_1^{*,dec}$, such that for $\bar{b}_1 \geq \bar{b}_1^{*}$, $(\bar{b}_1-B u_0^{\bar{b}_1}) \geq -3b_1$. Returning to equation (\ref{eq:prop_7_case_4_numerator}), we have for $\bar{b}_1 \geq \bar{b}^*_1$:
	\begin{equation*}
	\frac{1}{\bar{b}_1^2}\Delta SC^{\bar{b}_1}\geq\frac{B}{2}(\mathbb{E}(\xi))^2\int_{0}^{\frac{T}{2}} \left(\frac{u_t^{\bar{b}_1}}{\bar{b}_1} - \frac{w_t^{\bar{b}_1}}{\bar{b}_1}\right)^2 e^{2(b_1-3b_1)t}dt.
	\end{equation*}
	By the bounded convergence theorem,
	\begin{equation*}
	=\frac{B}{2}(\mathbb{E}(\xi))^2\int_{0}^{\frac{T}{2}} \frac{1}{B^2} e^{-4b_1t}dt=:c>0.
	\end{equation*}	
	Therefore,
	\begin{equation*}
